...
WorkflowMlstprofiler.initialise(params, log)
...
workflow MLSTPROFILER {
    ...
    // MODULE: MultiQC
    //
    workflow_summary    = WorkflowMlstprofiler.paramsSummaryMultiqc(workflow, summary_params)
    ch_workflow_summary = Channel.value(workflow_summary)

    methods_description    = WorkflowMlstprofiler.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description, params)
